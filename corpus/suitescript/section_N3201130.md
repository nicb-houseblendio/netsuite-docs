...
breadcrumb: "SuiteCloud Platform > SuiteScript > SuiteScript Records Guide > SuiteScript Supported Records > Lists > Account"
parent: "chapter_N3200673"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_N3201130.html"
anchors: ["bridgehead_1492199149", "bridgehead_1492199265"]
sha256: "be53bd7fc5386913aeb64c66982e6c18485dbe18f8dbae15caf7d55350a9b241"
---

For help working with this record in the UI, see [Chart of Accounts Management](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_N1439850.html).

The internal ID for this record is `account`.

See the [SuiteScript Records Browser](https://system.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2026_1/script/record/account.html) for all internal IDs associated with this record.
...
## Supported Script Types {#bridgehead_1492199149}

The accounting book record is supported in server SuiteScript only.

## Supported Functions {#bridgehead_1492199265}

The account record is fully scriptable using server SuiteScript.

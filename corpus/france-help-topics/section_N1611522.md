...
id: "section_N1611522"
type: "section"
title: "Setting Up Company Bank Records in France"
branch: "france-help-topics"
category: "country-specific-features"
breadcrumb: "Country-Specific Features > France Help Topics > France-Specific SuiteApps > France Localization > France Payment Formats > Setting Up Company Bank Records in France"
parent: "section_1557744471"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_N1611522.html"
anchors: ["procedure_N1611534"]
sha256: "d4459451507ff8ffdb75787200a2342bfe55cfe9c9d18574c065f03ff9879c8e"
---
...
#### To set up company bank details in France: {#procedure_N1611534}
...
2.  Complete the fields on the New Company Bank Details page.
    ...
    | EFT Template | Select a France-specific bank payment template. |
...
5.  Complete the fields on the **EFT Template Details** subtab. The fields displayed depend on the EFT format selected.
    ...
    | Bank Code | Enter the 5-digit numeric code that identifies your company's bank. |
    | SIRET Number | Enter the 14-digit French company and branch registration number of the bank. |
    | Bank Branch Number | Enter the 5-digit code that identifies the bank branch where your company's account is maintained. |
    | Account Number | Enter your company's bank account number. |
    | Issuer Number | Enter the 6-digit numeric code issued by the bank to identify the payment transfers. |

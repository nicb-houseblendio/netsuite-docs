---
id: "SBADVTemplates_1965473176"
type: "SBADVTemplates"
title: "Standard Item Label PDF/HTML Template"
branch: "template-customization"
category: "suitecloud-platform"
breadcrumb: "SuiteCloud Platform > Template Customization > Advanced Templates Reference > Standard Item Label PDF/HTML Template"
parent: "SBADVTemplates"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/SBADVTemplates_1965473176.html"
anchors: ["SBADVTemplates_762492012", "SBADVTemplates_111053393", "SBADVTemplates_2165370302", "SBADVTemplates_2596610102"]
sha256: "287ff99e56b90ad32c480770bd49d2217c22ff4293b604713b7cdafcc834f169"
---
...
The fields and sublists available in the Standard Item Label PDF/HTML Template template are listed below.

## Label - label {#SBADVTemplates_762492012}

The following fields are available for the Label record.

| Name | Type | ID |
| --- | --- | --- |
| Bar Code | text | skuupcbarcode |
| Expiration Date | date | expirationdate |
| ID | number | id |
| Name | text | name |
| Price | number | price |
| Serial Number | text | serialnumber |
| UPC Code | checkbox | upc |

## Company Information - companyinformation {#SBADVTemplates_111053393}
...
## User - user {#SBADVTemplates_2165370302}
...
## Preference - preferences {#SBADVTemplates_2596610102}

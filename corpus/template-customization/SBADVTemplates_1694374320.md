---
id: "SBADVTemplates_1694374320"
type: "SBADVTemplates"
title: "Standard Customer Payment PDF/HTML Template"
branch: "template-customization"
category: "suitecloud-platform"
breadcrumb: "SuiteCloud Platform > Template Customization > Advanced Templates Reference > Standard Customer Payment PDF/HTML Template"
parent: "SBADVTemplates"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/SBADVTemplates_1694374320.html"
anchors: ["SBADVTemplates_271066032", "SBADVTemplates_895071472", "SBADVTemplates_4163601738", "SBADVTemplates_1006318000", "SBADVTemplates_630414088", "SBADVTemplates_3995729514", "SBADVTemplates_2407484151"]
sha256: "698e1ac5d4c91ef2b28a634ead37c31fb03aa9b4b8243cc28963f2436dfbbc8a"
---
...
The fields and sublists available in the Standard Customer Payment PDF/HTML Template template are listed below.

## Record - record {#SBADVTemplates_271066032}

The following fields are available for the Record record.

| Name | Type | ID |
| --- | --- | --- |
| A/R Account | select | aracct |
...
| Charge Credit Card | checkbox | chargeit |
| Class | select | class |
...
| Payment # | text | tranid |
| Payment Amount | poscurrency | payment |
...
### Sublists {#SBADVTemplates_895071472}
...
-   The **credit** sublist has the following fields:
    
    | Name | Type | ID |
    | --- | --- | --- |
    | Amount Remaining | currency | due |
    | Apply | checkbox | apply |
    | Credit | currency | amount |
    | Currency | text | currency |
    | Date | date | creditdate |
    | Hidden | text | internalid |
    | Hidden | text | trantype |
    | Orig. Amt. | currency | total |
    | Ref No. | text | refnum |
...
-   The **deposit** sublist has the following fields:
    
    | Name | Type | ID |
    | --- | --- | --- |
    | Amount Remaining | currency | remaining |
    | Apply | checkbox | apply |
    | Currency | text | currencyname |
    | Date | date | depositdate |
    | Orig. Amt. | currency | total |
    | Payment | currency | amount |
    | Ref No. | text | refnum |
...
## Company Information - companyinformation {#SBADVTemplates_4163601738}
...
## Subsidiary - subsidiary {#SBADVTemplates_1006318000}
...
### Sublists {#SBADVTemplates_630414088}
...
## User - user {#SBADVTemplates_3995729514}
...
## Preference - preferences {#SBADVTemplates_2407484151}

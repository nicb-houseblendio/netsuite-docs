...
sha256: "d3fa4a2b849007bd23dee9cc42c8a0249ca4ac71575338245b39de142511f78d"
---
...
For example:
              ...
              `<div data-exclude-facets="commercecategoryname,category,myfacet,myotherfacet><div>` 
            

Note:

If you're using SuiteCommerce or SuiteCommerce Advanced 2021.2 or later, you can use the `defineSearchMasterOptions()` method on the Environment component to set site-wide defaults for the Item Search API, like stopping facets from rendering.

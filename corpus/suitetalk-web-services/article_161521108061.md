---
id: "article_161521108061"
type: "article"
title: "Vendor Subsidiary Relationship"
branch: "suitetalk-web-services"
category: "suitecloud-platform"
breadcrumb: "SuiteCloud Platform > SuiteTalk Web Services > SuiteTalk REST Web Services Records Guide > REST Web Services Supported Records > Vendor Subsidiary Relationship"
parent: "chapter_1558962745"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_161521108061.html"
anchors: ["subsect_161521135652", "subsect_161881511925", "subsect_161521460378", "subsect_161521135651", "subsect_161881514215"]
sha256: "d99ac063be1c40f8499a4bbe15103d9c5c6601306bd555895b0fde1fd0bf1e2c"
---
...
## Updatable Fields on the vendorSubsidiaryRelationship Record {#subsect_161521460378}
...
## Supported Operations {#subsect_161521135651}
...
## Code Samples {#subsect_161881514215}

The following code sample shows how to get a specific vendorSubsidiaryRelationship record:

            `GET https://123456.suitetalk.api.netsuite.com/services/rest/record/v1/vendorsubsidiaryrelationship?q=entity EQUAL 13 AND subsidiary EQUAL 5` 
...
The following code sample shows how to get the ID of a specific vendorSubsidiaryRelationship record:
            ...
            `Header: 'prefer: transient' 'Content-Type: application/json' Body: '{ "q": "SELECT id FROM vendorSubsidiaryRelationship WHERE entity = 13 AND subsidiary = 5" }'` 
...
The following code sample shows how to set the externalId and creditLimit for a specific vendorSubsidiaryRelationship record:
            ...
            `Header: 'Content-Type: application/json' Body: '{ "externalId": "VSR1", "creditLimit": 150 }'` 

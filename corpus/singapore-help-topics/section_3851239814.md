---
id: "section_3851239814"
type: "section"
title: "Setting Up Bank Records of Partners in Singapore"
branch: "singapore-help-topics"
category: "country-specific-features"
breadcrumb: "Country-Specific Features > Singapore Help Topics > Singapore Payment Formats > Setting Up Bank Records of Partners in Singapore"
parent: "section_N1642722"
source: "https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_3851239814.html"
anchors: ["procedure_3851240033"]
sha256: "97e475dab82c241ff3e33efff55bb627a39eaed2c2b7563c4f3e40c77074ee3a"
---
...
#### To set up partner bank details in Singapore: {#procedure_3851240033}
...
5.  Complete the fields on the Bank Details page. The fields displayed are dependent on the selected Payment File Format. The following table lists the common fields displayed, you may disregard those that are not displayed.
    ...
    | EFT Template | Select any of the following Electronic Fund Transfer (EFT) payment file formats to use when sending payments to this partner:
    ...
    | Bank Number/Bank Code | Enter the 4-digit number that identifies the partner's bank. |
    ...
    | Street Name | Enter the street name of the partner's address. |
    | Building Number | Enter the building number of the partner's address. |
    | Post Code | Enter the post code of the partner's address. |
    | Town Name | Enter the town name of the partner's address. |
    | Country Subdivision | Enter the country subdivision of the partner's address. |
    | Address Line | Enter any additional details of the partner's address. |
